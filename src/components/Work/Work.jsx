...
const Work = ({ title, description, projects }) => {
    ...
    return (
        <section
            id={title.toLowerCase().replace(/\s+/g, '-')} // Dynamic ID based on title
        ...
        >
            ...
            {selectedProject && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90 p-4">
                    <div ref={modelRef} className="bg-gray-900 rounded-xl shadow-2xl lg:w-full w-[90%] max-w-3xl overflow-hidden relative">
